...
## DESCRIPTION
Before applying provided R scripts, Bulk RNA-seq and DNase-seq data were pre-processed using custom pipelines [**Workflow_RNA-seq**](https://github.com/JosephLeger/Workflow_RNA-seq) release v1.0.0 and [**Workflow_ChIP-like**](https://github.com/JosephLeger/Workflow_ChIP-like) release v1.0.0. Single cell RNA-seq data were pre-processed using **CellRanger**.
