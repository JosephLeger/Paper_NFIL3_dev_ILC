...
DATA_DIR     <- 'C:/Users/E15639P/Desktop/GitHub_NF_dev_ILC/Data/Bulk_RNA-seq/Tox/genes.results'
SAMPLE_SHEET <- 'C:/Users/E15639P/Desktop/GitHub_NF_dev_ILC/Data/Bulk_RNA-seq/Tox/SampleSheet_Bulk_RNA.csv'
COMP_TO_MAKE <- 'C:/Users/E15639P/Desktop/GitHub_NF_dev_ILC/Data/Bulk_RNA-seq/Tox/Comparisons_to_make.csv' 
...
dir.create(file.path(paste0(PATH, '/Figures/Bulk_RNA-seq'), 'Tox'))
dir.create(file.path(paste0(PATH, '/Saves'), 'Bulk_RNA-seq'))
dir.create(file.path(paste0(PATH, '/Saves/Bulk_RNA-seq'), 'Tox'))

# Set up path for figures and saves
PATH_FIG  <- paste0(PATH, '/Figures/Bulk_RNA-seq/Tox')
PATH_SAVE <- paste0(PATH, '/Saves/Bulk_RNA-seq/Tox')
...
dev.print(png, file=paste0(PATH_FIG, '/Distrib_Raw.png'), 
          width=14, height=9, units='in', res=100)
...
Table_annotated  <- cbind(Symbol = Symbol, Table_norm)
...
## CUSTOM VOLCANOPLOT ----------------------------------------------------------
result           <- Results_list[["TOX_WT_vs_GFP_WT"]]
